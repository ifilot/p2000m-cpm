...
The chosen twelve-drive design is now implemented in version 0.1.0; the
...
configuration, now used by the 0.1.0 build. No partition or filesystem changes are made by rendering
